        ...
        <div class="row">
            <div class="col">
                ...
                <div class="data-table-boxed">
                    ...
                    <!-- Table Start -->
                    <div>
                        <table id="datatableBoxed" class="data-table nowrap hover stripe ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-muted text-small text-uppercase">Diinput Oleh</th>
                                    <th class="empty all" style="width: 3%;">&nbsp;</th>
                                </tr>
                            </thead>
