                                ...
                                <table class="data-table data-table-pagination data-table-standard responsive nowrap stripe"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-muted text-small text-uppercase">Nama Rekening</th>
                                            <th class="text-muted text-small text-uppercase">Nomor Rekening</th>
                                    ...
                                    <tbody>
                                        @foreach ($rekening as $item)
                                            <tr>
                                                ...
                                                <td class="text-alternate">{{ $item->rekening }}</td>
                                                <td class="text-alternate">{{ $item->no_rek }}</td>
