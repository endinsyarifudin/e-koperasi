@php
    ...
    $title = $title;
    $description = 'Data Jenis da Kategori Neraca';
    $breadcrumbs = [];
@endphp
...
@section('js_page')
    ...
    <script src="/js/data/data.jenisNeraca.js"></script>
@endsection
                ...
                <div class="page-title-container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                            ...
                            <a href="{{ route('jenisneraca.create') }}"
                                ...
                                <table class="data-table data-table-pagination data-table-standard responsive nowrap stripe"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-muted text-small text-uppercase">Jenis Neraca</th>
                                    ...
                                    <tbody>
                                        @foreach ($jenisNeraca as $item)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td class="text-alternate">{{ $item->akun }}</td>
                                                <td class="text-alternate">{{ $item->jenis }}</td>
                                                <td class="text-alternate">{{ optional($item->kategori)->kategori }}</td>
                                                <td class="text-alternate">{{ $item->deskripsi }}</td>
                                                <td class="text-alternate text-end" style="width: 6%;">
                                                    <a href="{{ route('jenisneraca.edit', $item->id) }}"
                                                    ...
                                                    <form action="{{ route('jenisneraca.destroy', $item->id) }}"
