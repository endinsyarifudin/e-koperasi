...
@section('js_page')
    ...
    <script src="{{ asset('/js/data/jenisLabarugi.serverside.js') }}"></script>
@endsection
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalTitle">Tambah Jenis</h5>
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Jenis Laba Rugi</label>
                                        <input name="jenis_labarugi" id="jenis_labarugi" type="text"
                                            class="form-control" />
                                    </div>
                                    <div class="mb-3">
